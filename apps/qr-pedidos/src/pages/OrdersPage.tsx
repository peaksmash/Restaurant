...
export default function OrdersPage() {
  ...
  const orders = JSON.parse(localStorage.getItem('qrp_orders') || '[]') as StoredOrder[]
    ...
    <div className={styles.page}>
      ...
      {orders.length === 0 ? (
        <div className={styles.empty}>
          ...
          <div className={styles.emptyTitle}>Todavia no has pedido</div>
          <div className={styles.emptySub}>Cuando hagas tu primer pedido aparecera aqui con su seguimiento.</div>
