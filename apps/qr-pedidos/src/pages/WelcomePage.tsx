...
export default function WelcomePage() {
  ...
  const { user, loginGoogle, loading, error, clearError } = useAuthStore()
  const config = useRestaurantStore((state) => state.config)
      ...
      <div className={styles.card}>
        ...
        {!isFirebaseAuthConfigured && (
          <div className={styles.error}>
            Firebase Auth no está configurado. Rellena <code>VITE_FIREBASE_*</code> en <code>.env.local</code>.
          </div>
        )}
